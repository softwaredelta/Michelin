      ...
      ? ids.map((idQuestion) => (
          <TableRow className="border-b">
            ...
            <TableCell className="text-center">
              <Checkbox className="scale-110" checked={entities[idQuestion].camera} disabled></Checkbox>
            </TableCell>
            <TableCell className="text-center">
              <Checkbox className="scale-110" checked={entities[idQuestion].btn_na} disabled></Checkbox>
            </TableCell>
          </TableRow>
        ))
      : null;
